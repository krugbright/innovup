      ...
      <ReavealRL>
        <div className="most-course__container-body">
          ...
          <CardCourse
            ...
            mentorImg={
              "https://images.unsplash.com/photo-1573496358961-3c82861ab8f4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1976&q=80"
            }
            mentorName={"Marveen AINADOU"}
            courseCat={"Science"}
            courseTitle={"La rédaction web"}
            courseDuration={"8h25min"}
            courseType={"3 vidéos"}
          />
        </div>
